   ...
   <div class="card-body">
      <form id="form-delete-gembala" action="<?= site_url('profile/delete')?>" method="post">
         <div class="form-group">
            ...
            <input value="<?= $profile->nama_gembala ?>" class="form-control col-5" name="nama_gembala"
               placeholder="Masukan Nama gembala " type="text">
         </div>
         <div class="form-group">
            <label for="">Deskripsi Gembala</label>
            <input value="<?= $profile->deskripsi_gembala ?>" class="form-control col-5" name="deskripsi_gembala"
               placeholder="Masukan Deskripsi Gembala" type="text">
         </div>
         <div class="form-group">
            <label for="">Riwayat Pendidikan</label>
            <input value="<?= $profile->riwayat_pendidikan ?>" class="form-control col-5" name="riwayat_pendidikan"
               placeholder="Masukan Riwayat Pendidikan" type="text">
         </div>
         <div class="form-group">
            <label for="">Role</label>
            <input value="<?= $profile->role?>" class="form-control col-5" name="role" placeholder="Masukan Role"
               type="text">
         </div>
