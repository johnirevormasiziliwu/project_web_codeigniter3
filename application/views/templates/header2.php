...
<head>
   ...
   <!-- Favicons -->
   <link href="assets/Logis/Logis/assets/img/favicon.png" rel="icon">
   <link href="assets/Logis/Logis/assets/assets/img/apple-touch-icon.png" rel="apple-touch-icon">

   <!-- Google Fonts -->
   <link rel="preconnect" href="assets/Logis/Logis/https://fonts.googleapis.com">
   ...
   <!-- Vendor CSS Files -->
   <link href="assets/Logis/Logis/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
   <link href="assets/Logis/Logis/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
   <link href="assets/Logis/Logis/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
   <link href="assets/Logis/Logis/assets/vendor/glightbox/css/glightbox.min.css" rel="stylesheet">
   <link href="assets/Logis/Logis/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
   <link href="assets/Logis/Logis/assets/vendor/aos/aos.css" rel="stylesheet">

   <!-- Template Main CSS File -->
   <link href="assets/Logis/Logis/assets/css/main.css" rel="stylesheet">
...
<body>
   ...
   <!-- Vendor JS Files -->
   <script src="assets/Logis/Logis/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
   <script src="assets/Logis/Logis/assets/vendor/purecounter/purecounter_vanilla.js"></script>
   <script src="assets/Logis/Logis/assets/vendor/glightbox/js/glightbox.min.js"></script>
   <script src="assets/Logis/Logis/assets/vendor/swiper/swiper-bundle.min.js"></script>
   <script src="assets/Logis/Logis/assets/vendor/aos/aos.js"></script>
   <script src="assets/Logis/Logis/assets/vendor/php-email-form/validate.js"></script>

   <!-- Template Main JS File -->
   <script src="assets/Logis/Logis/assets/js/main.js"></script>
